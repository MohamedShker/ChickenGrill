...
public class MealSidesActivity extends AppCompatActivity {
    ...
    private ArrayList<MealSides> getCombinationMeal() {
        ...
        for (int j = 0; j < i; j++) {
            ...
            switch (j){
                case 0 :
                    linearLayout = (LinearLayout) findViewById(R.id.FIRST_MEAL);
                    break;
                case 1 :
                    linearLayout = (LinearLayout) findViewById(R.id.SECOND_MEAL);
                    break;
                case 2 :
                    linearLayout = (LinearLayout) findViewById(R.id.THIRD_MEAL);
                    break;
                case 3 :
                    linearLayout = (LinearLayout) findViewById(R.id.FOURTH_MEAL);
                    break;
            }
                ...
                mealSide.setSalad(getCheckedBoxes(linearLayout));//sauces and salad choices are saved in the salads array of the eal side.
                ans.add(mealSide);
        }
    ...
    private void setCombinationLayoutsID(LinearLayout linearLayout, int j) {
        switch (j){
            case 0 :
                linearLayout.setId(R.id.FIRST_MEAL);
                break;
            case 1 :
                linearLayout.setId(R.id.FIRST_MEAL);
                break;
            case 2 :
                linearLayout.setId(R.id.SECOND_MEAL);
                break;
            case 3 :
                linearLayout.setId(R.id.SECOND_MEAL);
                break;
            case 4 :
                linearLayout.setId(R.id.THIRD_MEAL);
                break;
            case 5 :
                linearLayout.setId(R.id.THIRD_MEAL);
                break;
            case 6 :
                linearLayout.setId(R.id.FOURTH_MEAL);
                break;
            case 7 :
                linearLayout.setId(R.id.FOURTH_MEAL);
                break;
